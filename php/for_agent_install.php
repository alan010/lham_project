...
function release_agent() {
    $random_str_1=strval(random_int(1,9999));
    $random_str_2=strval(random_int(1,9999));
    $random_str_3=strval(random_int(1,9999));
    $tmp_release_dir=$WORK_DIR . "/pub/tmp_release/$random_str_1/$random_str_2/$random_str_3";

    mkdir($tmp_release_dir, 0755, true);
    symlink($agent_source, $tmp_release_dir . "/lham_agent.py");
